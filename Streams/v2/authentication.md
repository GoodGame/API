...
* Redirect URI - URI куда будет перенаправлен пользователь Goodgame, после того как подтвердит авторизацию вашего приложения на использование своего аккаунта. Если оставить пустым, то перенаправление будет на служебную страницу http://api2.goodgame.ru/oauth/recievecode
...
`state` - это любой сгенерированный вами идентификатор, необходим для избежания CSRF-атак на ваше приложение. Передается в неизменном виде при редиректе на ваш Redirec URI.
