...
Если сервер присоединяет клиента к каналу, то клиент информируется сообщением.
    ...
    //res_to_client
    {
        ...
        data: {
            ...
            group: 1, // на основе группы, определяется каким цветом выводить сообщения
...
* disabled *
Одновременно с этим, всем остальным клиентам в канале отсылается сообщение
...
* disabled *
Одновременно с этим, всем остальным клиентам в канале отсылается сообщение об отключении
клиента.
